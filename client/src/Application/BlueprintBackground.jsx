  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundImage: [
          "linear-gradient(rgba(126,157,101,.10) 1px, transparent 1px)",
          "linear-gradient(90deg, rgba(126,157,101,.10) 1px, transparent 1px)",
          "linear-gradient(rgba(126,157,101,.05) 1px, transparent 1px)",
          "linear-gradient(90deg, rgba(126,157,101,.05) 1px, transparent 1px)",
        ].join(","),
