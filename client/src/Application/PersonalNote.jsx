...
export default function PersonalNote() {
  return (
    <section className="section-pad relative isolate overflow-hidden bg-surface text-[#2D382B]">
      {/* כתמי אור עדינים */}
      ...
      <div className="page-wrap mx-auto grid max-w-5xl items-center gap-10 lg:grid-cols-[.6fr_1.4fr] lg:gap-12">
        {/* התמונה בעיגול (ימין) */}
